...
>
  <button on:click={() => dispatch('click')} class="flex items-center mb-4 md:mb-0 text-white/70">
    <CoffeeIcon />
    <div class="text-2xl md:text-xl font-bold ml-2">quickcafe.dev</div>
  </button>
  <a
    ...
    href="https://github.com/yashmit07/quickcafe"
    target="_blank"
